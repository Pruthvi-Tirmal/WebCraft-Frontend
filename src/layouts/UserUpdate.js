...
const UserUpdate = ({ flag = true }) => {
    ...
    return (
        <div className='relative md:mt-10 p-2 border'>
            {flag && (
                <h1 className='decoration-blue-500 underline decoration-wavy my-5 text-center font-semibold sm:text-4xl text-3xl'>Update Your Webpage🚀</h1>)
            }
            ...
            <div className='flex rounded-md overflow-x-hidden  relative flex-col sm:max-w-[90%] max-w-[95%] mx-auto mt-5 p-5 min-h-[100vh]  shadow-lg'>
                <div className=' relative flex items-center  mb-5'>
                    {/* navigation */}
                    <NaviUpdateSec />
                </div>
                <div className='flex min-h-[100vh]'>
                    <div className='w-full shadow-lg overflow-y-scroll h-[100vh] flex flex-col md:mt-12 mt-5  py-2'>
                        <Outlet />
                    </div>
                    <div className={`${show ? "right-0 top-0" : "right-[100%] lg:right-0"}  bg-white w-full absolute   rounded-md lg:block lg:relative lg:z-0 z-50`}>
                        ...
                        <div className={`${!show ? "overflow-y-scroll h-[100vh] p-5" : " min-h-[100vh]"}  shadow-lg`}>
                            <Template flag={false} />
                        </div>
                    </div>
                </div>
